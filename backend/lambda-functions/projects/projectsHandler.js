...
async function createProject(body) {
    ...
    if (existingProject) {
        return (0, response_1.errorResponse)(`Project with code '${data.code}' already exists for team '${data.team}'`, 409);
    }
...
async function updateProject(projectId, body) {
    ...
    if ((data.code && data.code !== existingProject.code) || (data.team && data.team !== existingProject.team)) {
        ...
        if (projectWithCode && projectWithCode.id !== projectId) {
            return (0, response_1.errorResponse)(`Project with code '${codeToCheck}' already exists for team '${teamToCheck}'`, 409);
        }
    }
